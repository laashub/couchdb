...
num_merges(BBChunk, NumBB, Count) when NumBB =< BBChunk ->
    Count;
num_merges(BBChunk, NumBB, Count) when NumBB > BBChunk ->
    RevNumBB = NumBB / BBChunk,
    FwdNumBB = RevNumBB / BBChunk,
    num_merges(BBChunk, FwdNumBB, Count + NumBB).
